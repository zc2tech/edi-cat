...
export class Info_842_Out extends DocInfoBase {
    ...
    public getUsage(seg: EdiSegment, ele: EdiElement): {} {
        ...
        switch (seg.astNode.fullPath) {
            case "ROOT_BNR":
                return Info_842_Out.usage_BNR[ele.designatorIndex]
                break;
            case "ROOT_REF":
                return Info_842_Out.usage_REF[ele.designatorIndex]
                break;
            case "ROOT_DTM":
                return Info_842_Out.usage_DTM[ele.designatorIndex]
                break;
            case "ROOT_N1_N1":
                return Info_842_Out.usage_N1_N1[ele.designatorIndex]
                break;
            case "ROOT_N1_N4":
                return Info_842_Out.usage_N1_N4[ele.designatorIndex]
                break;
            case "ROOT_HL_HL":
                return Info_842_Out.usage_HL_HL[ele.designatorIndex]
                break;
            case "ROOT_HL_LIN":
                return Info_842_Out.usage_HL_LIN[ele.designatorIndex]
                break;
            case "ROOT_HL_PID":
                return Info_842_Out.usage_HL_PID[ele.designatorIndex]
                break;
            case "ROOT_HL_DTM":
                return Info_842_Out.usage_HL_DTM[ele.designatorIndex]
                break;
            case "ROOT_HL_REF":
                return Info_842_Out.usage_HL_REF[ele.designatorIndex]
                break;
            case "ROOT_HL_QTY":
                return Info_842_Out.usage_HL_QTY[ele.designatorIndex]
                break;
            case "ROOT_HL_NCD_NCD":
                return Info_842_Out.usage_HL_NCD_NCD[ele.designatorIndex]
                break;
            case "ROOT_HL_NCD_DTM":
                return Info_842_Out.usage_HL_NCD_DTM[ele.designatorIndex]
                break;
            case "ROOT_HL_NCD_REF":
                return Info_842_Out.usage_HL_NCD_REF[ele.designatorIndex]
                break;
            case "ROOT_HL_NCD_QTY":
                return Info_842_Out.usage_HL_NCD_QTY[ele.designatorIndex]
                break;
            case "ROOT_HL_NCD_N1_N1":
                return Info_842_Out.usage_HL_NCD_N1_N1[ele.designatorIndex]
                break;
            case "ROOT_HL_NCD_N1_REF":
                return Info_842_Out.usage_HL_NCD_N1_REF[ele.designatorIndex]
                break;
            case "ROOT_HL_NCD_NCA_NTE":
                return Info_842_Out.usage_HL_NCD_NCA_NTE[ele.designatorIndex]
                break;
            case "ROOT_HL_NCD_NCA_DTM":
                return Info_842_Out.usage_HL_NCD_NCA_DTM[ele.designatorIndex]
                break;
            case "ROOT_HL_NCD_NCA_REF":
                return Info_842_Out.usage_HL_NCD_NCA_REF[ele.designatorIndex]
                break;
            case "ROOT_HL_NCD_NCA_N1_N1":
                return Info_842_Out.usage_HL_NCD_NCA_N1_N1[ele.designatorIndex]
                break;
            case "ROOT_HL_NCD_NTE": //usage_HL_NCD_NTE
                return Info_842_Out.usage_HL_NCD_NTE[ele.designatorIndex]
                break;
    ...
    public getComment(seg: EdiSegment, ele: EdiElement): string {
        switch (seg.astNode.fullPath) {
            case "ROOT_DTM":
                return Info_842_Out.comment_DTM[ele.designatorIndex];
                break;
            case "ROOT_N1_N4":
                return Info_842_Out.comment_N1_N4[ele.designatorIndex];
                break;
            case "ROOT_HL_DTM":
                return Info_842_Out.comment_HL_DTM[ele.designatorIndex];
                break;
            case "ROOT_HL_QTY":
                return Info_842_Out.comment_HL_QTY[ele.designatorIndex];
                break;
            case "ROOT_HL_NCD_DTM":
                return Info_842_Out.comment_HL_NCD_DTM[ele.designatorIndex];
                break;
            case "ROOT_HL_NCD_QTY":
                return Info_842_Out.comment_HL_NCD_QTY[ele.designatorIndex];
                break;
            case "ROOT_HL_NCD_NCA_DTM":
                return Info_842_Out.comment_HL_NCD_NCA_DTM[ele.designatorIndex];
                break;
            default:
