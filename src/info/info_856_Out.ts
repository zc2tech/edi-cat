...
export class Info_856_Out extends DocInfoBase {
    ...
    static usage_HL_LIN = {
        ...
        "12": DocInfoBase.ProductServiceIdQualifierList10,
        "14": DocInfoBase.ProductServiceIdQualifierList10,
        "16": DocInfoBase.ProductServiceIdQualifierList10,
        "18": DocInfoBase.ProductServiceIdQualifierList10,
        "20": DocInfoBase.ProductServiceIdQualifierList10,
        "22": DocInfoBase.ProductServiceIdQualifierList10,
        "24": DocInfoBase.ProductServiceIdQualifierList10,
        "26": DocInfoBase.ProductServiceIdQualifierList10,
    };
    ...
    public getUsage(seg: EdiSegment, ele: EdiElement): {} {
        ...
        switch (seg.astNode.fullPath) {
            case "ROOT_BSN":
                return Info_856_Out.usage_BSN[ele.designatorIndex]
                break;
            case "ROOT_DTM":
                return Info_856_Out.usage_DTM[ele.designatorIndex]
                break;
            case "ROOT_HL_HL":
                return Info_856_Out.usage_HL_HL[ele.designatorIndex]
                break;
            case "ROOT_HL_PID":
                return Info_856_Out.usage_HL_PID[ele.designatorIndex]
                break;
            case "ROOT_HL_MEA":
                return Info_856_Out.usage_HL_MEA[ele.designatorIndex]
                break;
            case "ROOT_HL_TD1":
                return Info_856_Out.usage_HL_TD1[ele.designatorIndex]
                break;
            case "ROOT_HL_TD5":
                return Info_856_Out.usage_HL_TD5[ele.designatorIndex]
                break;
            case "ROOT_HL_TD4":
                return Info_856_Out.usage_HL_TD4[ele.designatorIndex]
                break;
            case "ROOT_HL_REF":
                return Info_856_Out.usage_HL_REF[ele.designatorIndex]
                break;
            case "ROOT_HL_DTM":
                return Info_856_Out.usage_HL_DTM[ele.designatorIndex]
                break;
            case "ROOT_HL_FOB":
                return Info_856_Out.usage_HL_FOB[ele.designatorIndex]
                break;
            case "ROOT_HL_N1_N1":
                return Info_856_Out.usage_HL_N1_N1[ele.designatorIndex]
                break;
            case "ROOT_HL_N1_N4":
                return Info_856_Out.usage_HL_N1_N4[ele.designatorIndex]
                break;
            case "ROOT_HL_N1_REF":
                return Info_856_Out.usage_HL_N1_REF[ele.designatorIndex]
                break;
            case "ROOT_HL_N1_PER":
                return Info_856_Out.usage_HL_N1_PER[ele.designatorIndex]
                break;
            case "ROOT_HL_CUR":
                return Info_856_Out.usage_HL_CUR[ele.designatorIndex]
                break;
            case "ROOT_HL_MAN":
                return Info_856_Out.usage_HL_MAN[ele.designatorIndex]
                break;
            case "ROOT_HL_LIN":
                return Info_856_Out.usage_HL_LIN[ele.designatorIndex]
                break;
    ...
    public getComment(seg: EdiSegment, ele: EdiElement): string {
        switch (seg.astNode.fullPath) {
           case "ROOT_DTM":
                return Info_856_Out.comment_DTM[ele.designatorIndex];
                break;
            case "ROOT_HL_MEA":
                return Info_856_Out.comment_HL_MEA[ele.designatorIndex];
                break;
            case "ROOT_HL_TD1":
                return Info_856_Out.comment_HL_TD1[ele.designatorIndex];
                break;
            case "ROOT_HL_TD5":
                return Info_856_Out.comment_HL_TD5[ele.designatorIndex];
                break;
            case "ROOT_HL_TD3":
                return Info_856_Out.comment_HL_TD3[ele.designatorIndex];
                break;
            case "ROOT_HL_REF":
                return Info_856_Out.comment_HL_REF[ele.designatorIndex];
                break;
            case "ROOT_HL_DTM":
                return Info_856_Out.comment_HL_DTM[ele.designatorIndex];
                break;
            case "ROOT_HL_FOB":
                return Info_856_Out.comment_HL_FOB[ele.designatorIndex];
                break;
            case "ROOT_HL_N1_N4":
                return Info_856_Out.comment_HL_N1_N4[ele.designatorIndex];
                break;
            case "ROOT_HL_PO4":
                return Info_856_Out.comment_HL_PO4[ele.designatorIndex];
                break;
            case "ROOT_HL_SN1":
                return Info_856_Out.comment_HL_SN1[ele.designatorIndex];
                break;
            default:
