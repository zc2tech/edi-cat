...
export class Info_850 extends DocInfoBase {
    ...
    static comment_PO1_PO3 = {
        "07": `**Unit or Basis for Measurement Code**\n\nCode specifying the units in which a value is being `
            + `expressed, or manner in which a measurement has been taken. Please refer to `
            + `APPENDIX - [CODELISTS 355 Unit or Basis for Measurement Code \[UOM\]](command:edi-cat.showCodeList?${DocInfoBase.paramString(355)})`,
    }
    static comment_PO1_CTP_CTP = {
    ...
    static comment_PO1_SAC_SAC = {
        "02": `**Service, Promotion, Allowance, or Charge Code**\n\nPlease refer to APPENDIX - `
            + `[CODELISTS 1300 Service, Promotion, Allowance, or Charge Code](command:edi-cat.showCodeList?${DocInfoBase.paramString(1300)})`,
    }

    static comment_PO1_FOB = {
        "01": `**Shipment Method of Payment**\n\n`
            + `Please refer to APPENDIX - [CODELISTS 146 Shipment Method of Payment]`
            + `(command:edi-cat.showCodeList?${DocInfoBase.paramString(146)})`,
    }

    static comment_PO1_SDQ = {
    ...
    public getUsage(seg: EdiSegment, ele: EdiElement): {} {
        ...
        switch (seg.astNode.fullPath) {
            case "ROOT_BGN":
                return Info_850.usage_BEG[ele.designatorIndex]
                break;
            case "ROOT_CUR":
                return Info_850.usage_CUR[ele.designatorIndex]
                break;
            case "ROOT_REF":
                return Info_850.usage_REF[ele.designatorIndex]
                break;
            case "ROOT_FOB":
                return Info_850.usage_FOB[ele.designatorIndex]
                break;
            case "ROOT_CSH":
                return Info_850.usage_CSH[ele.designatorIndex]
                break;
            case "ROOT_SAC_SAC":
                return Info_850.usage_SAC_SAC[ele.designatorIndex]
                break;
            case "ROOT_SAC_CUR":
                return Info_850.usage_SAC_CUR[ele.designatorIndex]
                break;
            case "ROOT_ITD":
                return Info_850.usage_ITD[ele.designatorIndex]
                break;
            case "ROOT_DTM":
                return Info_850.usage_DTM[ele.designatorIndex]
                break;
            case "ROOT_PID":
                return Info_850.usage_PID[ele.designatorIndex]
                break;
            case "ROOT_TXI":
                return Info_850.usage_TXI[ele.designatorIndex]
                break;
            case "ROOT_N9_N9":
                return Info_850.usage_N9_N9[ele.designatorIndex]
                break;
            case "ROOT_N9_DTM":
                return Info_850.usage_N9_DTM[ele.designatorIndex]
                break;
            case "ROOT_N9_MSG":
                return Info_850.usage_N9_MSG[ele.designatorIndex]
                break;
            case "ROOT_N1_N1":
                return Info_850.usage_N1_N1[ele.designatorIndex]
                break;
            case "ROOT_N1_N4":
                return Info_850.usage_N1_N4[ele.designatorIndex]
                break;
            case "ROOT_N1_REF":
                return Info_850.usage_N1_REF[ele.designatorIndex]
                break;
            case "ROOT_N1_PER":
                return Info_850.usage_N1_PER[ele.designatorIndex]
                break;
            case "ROOT_N1_TD5":
                return Info_850.usage_N1_TD5[ele.designatorIndex]
                break;
            case "ROOT_N1_TD4":
                return Info_850.usage_N1_TD4[ele.designatorIndex]
                break;
            case "ROOT_PO1_PO1":
                return Info_850.usage_PO1_PO1[ele.designatorIndex]
                break;
            case "ROOT_PO1_CUR":
                return Info_850.usage_PO1_CUR[ele.designatorIndex]
                break;
            case "ROOT_PO1_PO3":
                return Info_850.usage_PO1_PO3[ele.designatorIndex]
                break;
            case "ROOT_PO1_CTP_CTP":
                return Info_850.usage_PO1_CTP_CTP[ele.designatorIndex]
                break;
            case "ROOT_PO1_CTP_CUR":
                return Info_850.usage_PO1_CTP_CUR[ele.designatorIndex]
                break;
            case "ROOT_PO1_MEA":
                return Info_850.usage_PO1_MEA[ele.designatorIndex]
                break;
            case "ROOT_PO1_PID_PID":
                return Info_850.usage_PO1_PID_PID[ele.designatorIndex]
                break;
            case "ROOT_PO1_REF":
                return Info_850.usage_PO1_REF[ele.designatorIndex]
                break;
            case "ROOT_PO1_SAC_SAC":
                return Info_850.usage_PO1_SAC_SAC[ele.designatorIndex]
                break;
            case "ROOT_PO1_SAC_CUR":
                return Info_850.usage_PO1_SAC_CUR[ele.designatorIndex]
                break;
            case "ROOT_PO1_FOB":
                return Info_850.usage_PO1_FOB[ele.designatorIndex]
                break;
            case "ROOT_PO1_SDQ":
                return Info_850.usage_PO1_SDQ[ele.designatorIndex]
                break;
            case "ROOT_PO1_DTM":
                return Info_850.usage_PO1_DTM[ele.designatorIndex]
                break;
            case "ROOT_PO1_TXI":
                return Info_850.usage_PO1_TXI[ele.designatorIndex]
                break;
            case "ROOT_PO1_QTY_QTY":
                return Info_850.usage_PO1_QTY_QTY[ele.designatorIndex]
                break;
            case "ROOT_PO1_SCH_SCH":
                return Info_850.usage_PO1_SCH_SCH[ele.designatorIndex]
                break;
            case "ROOT_PO1_SCH_REF":
                return Info_850.usage_PO1_SCH_REF[ele.designatorIndex]
                break;
            case "ROOT_PO1_PKG_PKG":
                return Info_850.usage_PO1_PKG_PKG[ele.designatorIndex]
                break;
            case "ROOT_PO1_PKG_MEA":
                return Info_850.usage_PO1_PKG_MEA[ele.designatorIndex]
                break;
            case "ROOT_PO1_N9_N9":
                return Info_850.usage_PO1_N9_N9[ele.designatorIndex]
                break;
            case "ROOT_PO1_N9_MSG":
                return Info_850.usage_PO1_N9_MSG[ele.designatorIndex]
                break;
            case "ROOT_PO1_N1_N1":
                return Info_850.usage_PO1_N1_N1[ele.designatorIndex]
                break;
            case "ROOT_PO1_N1_N4":
                return Info_850.usage_PO1_N1_N4[ele.designatorIndex]
                break;
            case "ROOT_PO1_N1_REF":
                return Info_850.usage_PO1_N1_REF[ele.designatorIndex]
                break;
            case "ROOT_PO1_N1_PER":
                return Info_850.usage_PO1_N1_PER[ele.designatorIndex]
                break;
            case "ROOT_PO1_N1_TD5":
                return Info_850.usage_PO1_N1_TD5[ele.designatorIndex]
                break;
            case "ROOT_PO1_N1_TD4":
                return Info_850.usage_PO1_N1_TD4[ele.designatorIndex]
                break;
            case "ROOT_PO1_SLN_SLN":
                return Info_850.usage_PO1_SLN_SLN[ele.designatorIndex]
                break;
            case "ROOT_PO1_SLN_DTM":
                return Info_850.usage_PO1_SLN_DTM[ele.designatorIndex]
                break;
            case "ROOT_PO1_SLN_N9_N9":
                return Info_850.usage_PO1_SLN_N9_N9[ele.designatorIndex]
                break;
            case "ROOT_CTT":
                return Info_850.usage_CTT_AMT[ele.designatorIndex]
                break;
    ...
    public getComment(seg: EdiSegment, ele: EdiElement): string {
        switch (seg.astNode.fullPath) {
            case "ROOT_FOB":
                return Info_850.comment_FOB[ele.designatorIndex];
                break;
            case "ROOT_SAC_SAC":
                return Info_850.comment_SAC_SAC[ele.designatorIndex];
                break;
            case "ROOT_DTM":
                return Info_850.comment_DTM[ele.designatorIndex];
                break;
            case "ROOT_N1_N4":
                return Info_850.comment_N1_N4[ele.designatorIndex];
                break;
            case "ROOT_PO1_PO1":
                return Info_850.comment_PO1_PO1[ele.designatorIndex];
                break;
            case "ROOT_PO1_PO3":
                return Info_850.comment_PO1_PO3[ele.designatorIndex];
                break;
            case "ROOT_PO1_CTP_CTP":
                return Info_850.comment_PO1_CTP_CTP[ele.designatorIndex];
                break;
            case "ROOT_PO1_MEA":
                return Info_850.comment_PO1_MEA[ele.designatorIndex];
                break;
            case "ROOT_PO1_SAC_SAC":
                return Info_850.comment_PO1_SAC_SAC[ele.designatorIndex];
                break;
            case "ROOT_PO1_FOB":
                return Info_850.comment_PO1_FOB[ele.designatorIndex];
                break;
            case "ROOT_PO1_SDQ":
                return Info_850.comment_PO1_SDQ[ele.designatorIndex];
                break;
            case "ROOT_PO1_DTM":
                return Info_850.comment_PO1_DTM[ele.designatorIndex];
                break;
            case "ROOT_PO1_SCH_SCH":
                return Info_850.comment_PO1_SCH_SCH[ele.designatorIndex];
                break;
            case "ROOT_PO1_PKG_MEA":
                return Info_850.comment_PO1_PKG_MEA[ele.designatorIndex];
                break;
            case "ROOT_PO1_N9_N9":
                return Info_850.comment_PO1_N9_N9[ele.designatorIndex];
                break;
            case "ROOT_PO1_N1_N4":
                return Info_850.comment_PO1_N1_N4[ele.designatorIndex];
                break;
            case "ROOT_PO1_SLN_SLN":
                return Info_850.comment_PO1_SLN_SLN[ele.designatorIndex];
                break;
            case "ROOT_PO1_SLN_DTM":
                return Info_850.comment_PO1_SLN_DTM[ele.designatorIndex];
                break;
