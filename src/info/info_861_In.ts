...
export class Info_861_In extends DocInfoBase {
    static usage_BRA = {
        "03": {
            "00": "Original",
            "03": "Delete*",
    ...
    public getUsage(seg: EdiSegment, ele: EdiElement): {} {
        ...
        switch (seg.astNode.fullPath) {
            case "ROOT_BRA":
                return Info_861_In.usage_BRA[ele.designatorIndex]
                break;
            case "ROOT_CUR":
                return Info_861_In.usage_CUR[ele.designatorIndex]
                break;
            case "ROOT_REF":
                return Info_861_In.usage_REF[ele.designatorIndex]
                break;
            case "ROOT_DTM":
                return Info_861_In.usage_DTM[ele.designatorIndex]
                break;
            case "ROOT_RCD_CUR":
                return Info_861_In.usage_RCD_CUR[ele.designatorIndex]
                break;
            case "ROOT_RCD_LIN":
                return Info_861_In.usage_RCD_LIN[ele.designatorIndex]
                break;
            case "ROOT_RCD_PID":
                return Info_861_In.usage_RCD_PID[ele.designatorIndex]
                break;
            case "ROOT_RCD_REF":
                return Info_861_In.usage_RCD_REF[ele.designatorIndex]
                break;
            case "ROOT_RCD_DTM":
                return Info_861_In.usage_RCD_DTM[ele.designatorIndex]
                break;
            case "ROOT_RCD_MAN":
                return Info_861_In.usage_RCD_MAN[ele.designatorIndex]
                break;
            case "ROOT_RCD_N1_N1":
                return Info_861_In.usage_RCD_N1_N1[ele.designatorIndex]
                break;
            case "ROOT_RCD_N1_N4":
                return Info_861_In.usage_RCD_N1_N4[ele.designatorIndex]
                break;
            case "ROOT_RCD_N1_REF":
                return Info_861_In.usage_RCD_N1_REF[ele.designatorIndex]
                break;
            case "ROOT_RCD_N1_PER":
                return Info_861_In.usage_RCD_N1_PER[ele.designatorIndex]
                break;
    ...
    public getComment(seg: EdiSegment, ele: EdiElement): string {
        switch (seg.astNode.fullPath) {
            case "ROOT_DTM":
                return Info_861_In.comment_DTM[ele.designatorIndex];
                break;
            case "ROOT_RCD_RCD":
                return Info_861_In.comment_RCD_RCD[ele.designatorIndex];
                break;
            case "ROOT_RCD_DTM":
                return Info_861_In.comment_RCD_DTM[ele.designatorIndex];
                break;
            case "ROOT_RCD_N1_N4":
                return Info_861_In.comment_RCD_N1_N4[ele.designatorIndex];
                break;
