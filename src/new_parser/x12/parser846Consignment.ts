...
import { Info_846_Consignment } from "../../info/info_846_Consignment";
import { ConvertPattern } from "../../cat_const";

/**
 * No need to make singleton because parserUtil already assured it
 */
export class Parser846Consignment extends SyntaxParserBase {
    constructor() {
        super();
        this._tableDFA = this._initDFA();
        this._parserKey = constants.versionKeys.X12_846_Consignment;
        this.docInfo = new Info_846_Consignment();
    }
