...
import { Info_830_ProductActivity } from "../../info/info_830_ProductActivity";
 ...
 */
export class Parser830ProductActivity extends SyntaxParserBase {
    constructor() {
        super();
        this._tableDFA = this._initDFA();
        this._parserKey = constants.versionKeys.X12_830_ProductActivity;
        this.docInfo = new Info_830_ProductActivity();
    }
