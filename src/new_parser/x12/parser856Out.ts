...
import { Info_856_Out } from "../../info/info_856_Out";
 ...
 */
export class Parser856Out extends SyntaxParserBase {
    constructor() {
        super();
        this._tableDFA = this._initDFA();
        this._parserKey = constants.versionKeys.X12_856_Out;
        this.docInfo = new Info_856_Out();
    }
