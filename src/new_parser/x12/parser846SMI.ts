...
import { Info_846_SMI } from "../../info/info_846_SMI";
import { ConvertPattern } from "../../cat_const";

/**
 * No need to make singleton because parserUtil already assured it
 */
export class Parser846SMI extends SyntaxParserBase {
    constructor() {
        super();
        this._tableDFA = this._initDFA();
        this._parserKey = constants.versionKeys.X12_846_SMI;
        this.docInfo = new Info_846_SMI();
    }
