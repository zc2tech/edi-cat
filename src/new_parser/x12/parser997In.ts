...
import { Info_997_In } from "../../info/info_997_In";
 ...
 */
export class Parser997In extends SyntaxParserBase {
    constructor() {
        super();
        this._tableDFA = this._initDFA();
        this._parserKey = constants.versionKeys.X12_997_In;
        this.docInfo = new Info_997_In();
    }
