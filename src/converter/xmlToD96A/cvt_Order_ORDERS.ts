 ...
 *
 */
export class Cvt_Order_ORDERS extends XmlConverterBase {
    ...
    public fromXML(vsdoc: vscode.TextDocument): string {
        ...
        // SG18, also include SG20,SG21
        this._SG18_Modification(nRequestHeader);
        ...
        for (let nItemOut of nItemOuts) {
            ...
            this._SG25_SubComponent(nItemOut, nScheduleLines)
        }
        // Summary
        // UNS
     ...
     * 
     */
    private _SG25(nItemOut: Element) {
        // LIN
        ...
        // PIA
        this._SG25_PIA(nItemOut, nItemDetail);
        ...
        // SG25 FTX
        this._SG25_FTX(nItemOut, nItemDetail, nBlanketItemDetail);
        ...
        if (vSupplierID) {
            ...
            this._setV(NAD, 1, 'SU');
            this._setV(NAD, 201, vSupplierID);
        ...
        if (nShipTo) {
            ...
            if (vDomain) {
                let REF = this._initSegEdi('REF', 1);
                if (this._mei(MAPS.mapNAD1153, vDomain)) {
                    this._setV(REF, 101, this._mci(MAPS.mapNAD1153, vDomain));
                }
                this._setV(REF, 102, this._v('IdReference', nShipTo));
            }
            // SG35 SG38 GR
            this._CTA('GR', '', '', this._e('Address', nShipTo));
        }

        // SG35, General Contact
        ...
        if (nDistribution) {
            ...
            this._setV(ALC, 505, arrDesc.join(''));
        ...
        } // end if nDiestribution, SG39 N

        // SG39  "A" for /AdditionalDeduction and "C" for /AdditionalCost
    ...
    */
    ...
    private _SG25_SG30_Batch(nBatch: Element) {
        // PAC
        let PAC = this._initSegEdi('PAC', 4);
        this._setV(PAC, 1, '0');
        this._setV(PAC, 401, 'A');
    ...
    private _SG25_SG30_Packaging(nPack: Element) {
        // PAC
        let PAC = this._initSegEdi('PAC', 4);
        this._setV(PAC, 1, '1');
    ...
    } // end function _SG25_SG30_Packaging
    private _SG25_SG29(nItemOut: Element, nItemDetail: Element, nBlanketItemDetail: Element) {
        // RFF FI
    ...
    private _SG25_FTX(nItemOut: Element, nItemDetail: Element, nBlanketItemDetail: Element) {
        // FTX AAK
    ...
    private _SG25_PIA(nItemOut: Element, nItemDetail: Element) {
        let iPIACounter = 2;
        let aPIA_1 = [];
        let aPIA_5 = [];
     ...
     */
    private _SG18_Modification(nRequestHeader: Element) {
