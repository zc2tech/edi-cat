...
export class Cvt_855_OrderConfirm extends ConverterBase {
    ...
    public toXML(): string {
        ...
        ordRef.att('orderID', this._segVal(BAK, 3));
        ...
        if (DTM004) {
            ...
            ordRef.att('orderDate', Utils.dateStrFromCCYYMMDD(BAK04));
        }

        // BAK08, @confirmID
        eConfH.att('confirmID', this._segVal(BAK, 8))
        ...
        if (DTMACK) {
            ...
            eConfH.att('noticeDate', Utils.dateStrFromCCYYMMDD(BAK09));
        }
    ...
    private _dealGrpSAC(grpSAC: ASTNode, eConfH: XMLBuilder) {
        ...
        switch (vSAC2) {
            ...
            case 'H850':
                ...
                eTax.ele('Money', this._segVal(SAC, 5))
                    .att(XML.currency, this._segVal(CUR, 2));
