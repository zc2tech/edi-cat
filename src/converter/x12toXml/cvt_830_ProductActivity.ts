 ...
 */
export class Cvt_830_ProductActivity extends ConverterBase {
    ...
    public toXML(): string {
        ...
        let eTmpExtrinsic = invoiceDetailRequestHeader.ele(XML.Extrinsic);
        ...
        if (BIG04 == 'NONPO') {
            // BIG04 = "NONPO"
            eTmpExtrinsic = invoiceDetailRequestHeader.ele(XML.Extrinsic);
