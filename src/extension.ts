...
import { AllConversionCommand } from "./commands/allConversionCommand";
...
export function activate(ctx: vscode.ExtensionContext) {
	...
	ParserUtilsBase.extensionContext = ctx;
	...
	ctx.subscriptions.push(vscode.commands.registerCommand('edi-cat.parseDocument', new ParseDocumentCommand().command));
