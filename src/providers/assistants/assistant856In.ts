 ...
 * 
 */
export class Assistant856In extends AssistantBase {
    public static versionKey = constants.versionKeys.X12_856_In
    ...
    _getHL1Children(): TreeItemElement[] | null | undefined {
        return [
            ...
            },
            {
                ...
                codeSample: `TD3*TL*EQ12*Trailer ID******Seal ID~`
            },
            {
                key: "TD4",
                type: TreeItemType.Segment,
            ...
            },
            {
                key: "REF",
                type: TreeItemType.Segment,
                desc: `References - Fulfillment`,
                codeSample: `REF*DD**complete~`
            },
            {
                key: "REF",
                type: TreeItemType.Segment,
            ...
            },
            {
                ...
                codeSample: `REF*CN*Tracking URL*20160111060000ET~`
            },
            {
                key: "REF",
                type: TreeItemType.Segment,
            ...
            },
            {
                ...
                codeSample: `REF*L1*01*Complex Shipment Text 01*L1>EN>0L>CommentType01 - first 30 Chars>0L>CommentType01 - next 30 Chars~`
            },
            {
                key: "REF",
                type: TreeItemType.Segment,
            ...
            },
            {
                ...
                type: TreeItemType.Segment,
                desc: `Date/Time`,
                codeSample: `DTM*011*20160111*141010*ET~`
            },
            {
                key: "FOB",
                type: TreeItemType.Segment,
            ...
            },
            {
                ...
                rootVersion: Assistant856In.versionKey,
    ...
    _getHL2Children(): TreeItemElement[] | null | undefined {
        return [
            ...
            },
            {
                ...
                codeSample: `PRF*Purchase Order ID***20160104**Agreement ID~`
            },
            {
                key: "PID",
                type: TreeItemType.Segment,
            ...
            },
            {
                ...
                type: TreeItemType.Segment,
                desc: `Date/Time`,
                codeSample: `DTM*004*20160104*093059*20~`
            },
            {
                key: "HL^2_N1",
                type: TreeItemType.Group,
    ...
    _getHL3Children(): TreeItemElement[] | null | undefined {
        return [
            ...
            },
            {
                ...
                type: TreeItemType.Segment,
                desc: `Measurements`,
                codeSample: `MEA*PD*VWT*20.99*CR~`
            },
            {
                key: "REF",
                type: TreeItemType.Segment,
                desc: `References`,
                codeSample: `REF*WS**Store ID~`
            },
            {
                key: "MAN",
                type: TreeItemType.Segment,
    ...
    _getHL4Children(): TreeItemElement[] | null | undefined {
        return [
            ...
            },
            {
                ...
                type: TreeItemType.Segment,
                desc: `Measurements`,
                codeSample: `MEA*PD*VWT*100.99*CM~`
            },
            {
                key: "REF",
                type: TreeItemType.Segment,
    ...
    _getHL5Children(): TreeItemElement[] | null | undefined {
        return [
            ...
            },
            {
                ...
                codeSample: `REF*BT*productionDate*20160108012000ED~`
            },
            {
                key: "REF",
                type: TreeItemType.Segment,
            ...
            },
            {
                ...
                codeSample: `REF*L1*01*Complex Item Text 01*L1>EN>0L>CommentType01 - first 30 Chars>0L>CommentType01 - next 30 Chars~`
            },
            {
                key: "REF",
                type: TreeItemType.Segment,
    ...
    _getRootChildren(): TreeItemElement[] | null | undefined {
        return [
            ...
            },
            {
                ...
                codeSample: `GS*SH*SenderID*ReceiverID*20160111*1314*1*X*004010~`
            },
            {
                key: "ST",
                type: TreeItemType.Segment,
            ...
            },
            {
                ...
                codeSample: `BSN*00*Ship Notice ID*20160111*131459*0001*PL*B44~`
            },
            {
                key: "DTM",
                type: TreeItemType.Segment,
