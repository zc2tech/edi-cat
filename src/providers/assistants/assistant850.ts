 ...
 * 
 */
export class Assistant850 extends AssistantBase {
    public static versionKey = constants.versionKeys.X12_850;
                    ...
                    return [
                        {
                            ...
                            codeSample: `SAC*A*B660*ZZ**4680*6*0.12******AMT_PRI*1*SAC-Description*EN~`
                        },
                        {
                            key: "CUR",
                            type: TreeItemType.Segment,
        ...
        return [
            {
                ...
                type: TreeItemType.Segment,
                desc: `Line Item Data`,
                codeSample: `PO1*10*100*EA*0.64**VP*Supplier Part ID*BP*Buyer Part ID*VS*Supplier Supplemental Part ID*MG*ManufacturerPart ID*MF*Manufacturer Name*C3*Classification*EN*EAN Part ID*UP*UPC Package ID~`
            },
            {
                key: "CUR",
                type: TreeItemType.Segment,
            ...
            },
            {
                ...
                rootVersion: Assistant850.versionKey,
                desc: `Pricing Details`,
                codeSample: ``
            },
            {
                key: "PO1_CTP^2",
            ...
            },
            {
                ...
                codeSample: `FOB*DF*ZZ*Description*01*EXW*ZZ*@TPTransport description@TODDelivery at the doorstep~`
            },
            {
                key: "SDQ",
                type: TreeItemType.Segment,
    ...
    _getPO1N1Children(): TreeItemElement[] | null | undefined {
        return [
            ...
            },
            {
                ...
                type: TreeItemType.Segment,
                desc: `Administrative Communications Contact`,
                codeSample: `PER*CN*Ship-To Contact Name*EM*e-mail Address*TE*Phone ID*UR*URL~`
            },
            {
                key: "TD5",
                type: TreeItemType.Segment,
    ...
    _getRootChildren(): TreeItemElement[] | null | undefined {
        return [
            ...
            },
            {
                ...
                codeSample: `GS*PO*SenderID*ReceiverID*20160104*093059*1*X*004010~`
            },
            {
                key: "ST",
                type: TreeItemType.Segment,
            ...
            },
            {
                ...
                codeSample: `BEG*00*DS*PurchaseOrderID*ReleaseID*20160104~`
            },
            {
                key: "CUR",
                type: TreeItemType.Segment,
