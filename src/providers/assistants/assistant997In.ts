 ...
 * 
 */
export class Assistant997In extends AssistantBase {
    public static versionKey = constants.versionKeys.X12_997_In
        ...
        return [
            {
                ...
                codeSample: `AK2*850*0001~`
            },
            {
                key: "AK2_AK3",
                type: TreeItemType.Group,
                rootVersion:Assistant997In.versionKey,
                desc: `Data Segment Note`,
                codeSample: ``
            },

            {
                ...
                codeSample: `AK5*R*19*20*21*22*23~`
            },
        ...
        return [
            {
                ...
                codeSample: `ISA*00*          *00*          *ZZ*SenderID       *ZZ*ReceiverID     *160104*0940*U*00401*000000001*0*T*>~`
            },
            {
                key: "GS",
                type: TreeItemType.Segment,
                desc: `Functional Group Header`,
                codeSample: `GS*FA*SenderID*ReceiverID*20160104*0940*1*X*004010~`
            },
            {
                key: "ST",
                type: TreeItemType.Segment,
          ...
          
            {
                ...
                codeSample: `AK9*R*1*1*0*19*20*21*22*23~`
            },
